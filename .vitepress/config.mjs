...
export default defineConfig({
  ...
  head: [
    ...
    ['script', { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-ED8FNV82QG' }],
    ['script', {}, `
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-ED8FNV82QG');
    `],
  ...
  srcExclude: [
    ...
    'blog/hoobuy-article-prompt.md',
    'blog/hoobuy-internal-link-rules.md',
    'blog/hoobuy-product-reference.md',
    'blog/hoobuy-review-report.md',
    'blog/hoobuy-topic-list.md',
