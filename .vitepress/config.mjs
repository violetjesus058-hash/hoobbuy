...
export default defineConfig({
  ...
  srcExclude: [
    ...
    'blog/hoobbuy-article-prompt.md',
    'blog/hoobbuy-internal-link-rules.md',
    'blog/hoobbuy-product-reference.md',
    'blog/hoobbuy-review-report.md',
    'blog/hoobbuy-topic-list.md',
