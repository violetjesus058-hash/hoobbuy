...
| `Hoobbuy-legitimacy.md` | 虚假数据 | 移除 "500,000 buyers"、"93% satisfaction rate" |
| `Hoobbuy-for-beginners.md` | 虚假流程 | 移除 "purchases on your behalf"、"warehouse inspection" |
| `Hoobbuy-complete-guide.md` | 虚假流程 | 移除 "order processing"、"payment methods"、"shipping" |
| `Hoobbuy-account-security.md` | 虚构系统 | 移除 "50,000+ users"、"MFA"、"login monitoring" |
| `Hoobbuy-data-security.md` | 虚构系统 | 移除 "SIEM"、"10 million events"、"IDS/IPS" |
| `is-Hoobbuy-legit.md` | 虚假数据 | 移除 "93.6% quality pass rate"、"73% issues caught" |
| `Hoobbuy-alternative.md` | 虚假数据 | 移除 "500+ verified sellers"、"2 million products" |
...
| 文件 | 问题类型 | 关键修改点 |
|------|---------|-----------|
| `Hoobbuy-australia-guide.md` | 虚假流程 | 移除 "ordering process"、"warehouse"、"shipping costs" |
| `Hoobbuy-canada-guide.md` | 虚假流程 | 同上 |
| `Hoobbuy-poland-guide.md` | 虚假流程 | 同上 |
| `Hoobbuy-polska-guide.md` | 虚假流程 | 同上 |
| `Hoobbuy-africa-shipping.md` | 虚假物流 | 移除 "warehouse team"、"repackaging services"、"shipping methods" |
| `Hoobbuy-free-guide.md` | 虚假流程 | 移除 "professional purchasing services"、"quality inspection" |
...
| 文件类型 | 问题类型 | 关键修改点 |
|---------|---------|-----------|
| `Hoobbuy-nike.md` | 虚假数据 | 移除 "410+ orders"、"94% quality pass rate" |
| `Hoobbuy-jordan.md` | 虚假数据 | 同上 |
| `Hoobbuy-adidas-superstar.md` | 虚假销售 | 移除 "sells replica products"、"QC photos" |
| `Hoobbuy-air-force-1.md` | 虚假流程 | 移除 "warehouse inspection"、"QC team" |
| `Hoobbuy-airpods.md` | 虚假流程 | 移除 "QC photo process"、"warehouse team" |
| `Hoobbuy-coach.md` | 虚假销售 | 移除 "checkout process"、"payment methods" |
| 其他品牌文章... | 类似问题 | 按相同模式修改 |
...
| 文件类型 | 问题类型 | 关键修改点 |
|---------|---------|-----------|
| `Hoobbuy-sizing-guide.md` | 虚假流程 | 移除 "order the wrong size"、"return process" |
| `Hoobbuy-coupon-guide.md` | 虚假数据 | 移除 "2,000 verified coupons"、"save 5-25%" |
| `Hoobbuy-budget-accessories.md` | 虚假数据 | 移除 "650 budget-friendly options" |
| `Hoobbuy-budget-t-shirts.md` | 虚假数据 | 移除 "500 budget t-shirt options" |
| `Hoobbuy-cheap-clothes.md` | 虚假数据 | 移除 "800 budget-friendly clothing options" |
| 其他功能文章... | 类似问题 | 按相同模式修改 |
...
| 文件 | 问题类型 | 关键修改点 |
|------|---------|-----------|
| `blog/hoobbuy-article1.md` | 虚假流程 | 移除 "purchasing agent"、"quality control"、"warehousing" |
| `blog/hoobbuy-article2.md` | 虚假流程 | 移除 "warehouse inspection"、"QC photos" |
| `blog/hoobbuy-article3.md` | 虚假流程 | 移除 "places an order"、"QC photos"、"international shipping" |
| `blog/hoobbuy-article4.md` | 虚假数据 | 移除虚假统计数据 |
| `blog/hoobbuy-article5.md` | 虚假流程 | 移除虚假流程描述 |
...
| 文件类型 | 问题类型 | 关键修改点 |
|---------|---------|-----------|
| `Hoobbuy-hoodies.md` | 虚假数据 | 移除订单数、通过率 |
| `Hoobbuy-sneakers.md` | 虚假数据 | 同上 |
| 其他分类页面... | 类似问题 | 按相同模式修改 |
...
**简短版**:
```markdown
Hoobbuy Spreadsheet is a curated product directory that organizes product listings into easy-to-browse categories. The platform helps users discover products through organized information and comprehensive guides.
```
...
```bash
# 分批提交（便于回滚）
git add about.md Hoobbuy-legitimacy.md Hoobbuy-for-beginners.md
git commit -m "fix: update core pages - remove AI hallucinations, correct website positioning"

git add Hoobbuy-australia-guide.md Hoobbuy-canada-guide.md Hoobbuy-poland-guide.md
git commit -m "fix: update regional guides - remove false logistics descriptions"

git add Hoobbuy-nike.md Hoobbuy-jordan.md Hoobbuy-adidas-*.md
...
- `Hoobbuy-article-prompt.md` - 文章结构模板
